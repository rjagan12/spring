...
import com.i2i.springboot.util.CommonUtil;
...
public class TrainerController {
    ...
    public TrainerController(EmployeeServiceImpl employeeService) {
    ...
    public String addTrainer(@RequestBody Trainer trainer) throws IOException,Exception {
        String message ="";
        if (null != trainer) {
           trainer = employeeService.addTrainerDetails(trainer);
           message = (null != trainer) ? "Inserted Successfully" : " Failed :: Not Inserted ";;
        }
            return message;
    }
    /**
                                    ...
                                    if (CommonUtil.panValidation(companyName)) {
                                        ...
                                        if (0 != experience) {
                                            ...
                                            try {
                                                 ...
                                                 message = String.valueOf(employeeService.addTrainerDetails(trainers));
