...
public class TraineeController  {
    ...
    public TraineeController(EmployeeServiceImpl employeeService) {
    ...
    public String addTrainee(@RequestBody Trainee trainee) throws Exception {
        ...
        if (null != trainee) {
            return message = String.valueOf(employeeService.addTraineeDetails(trainee));
        } else{
            return message;
        }
    }
                            ...
                            if (CommonUtil.addressValidation(address)) {
                                ...
                                if (CommonUtil.aadharValidation(aadharNumber)) {
                                    ...
                                    try {
                                        ...
                                        message = String.valueOf(employeeService.addTraineeDetails(trainees));
